const CONFIG = {
  ...
  matches: {
    ...
    final: [
      { id:"final-1", teamA:"Espanha", teamB:"Argentina", scoreA:1, scoreB:0, winner:"A", resolution:"regular", date:"2026-07-19", time:"16:00", venue:"MetLife Stadium, Nova Jersey" },
    ],
  },
